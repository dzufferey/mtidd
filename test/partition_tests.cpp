...
namespace mtidd {
  ...
  TEST_CASE("map") {
    ...
    //
    function<shared_ptr<const int> (shared_ptr<const int>)> mapper = [&](shared_ptr<const int> x) -> shared_ptr<const int> {
        if (x == a1) return a2;
  ...
  TEST_CASE("merge") {
    ...
    function<shared_ptr<const int> (shared_ptr<const int>, shared_ptr<const int>)> merger = [&](shared_ptr<const int> x, shared_ptr<const int> y) -> shared_ptr<const int> {
      cnt++;
